...
void CreateVBO(void)
{
	...
	GLfloat Vertices[] =
	{
		...
		// coordonate                   // culori			
		-70.0f,  -70.0f, -50.0f, 1.0f,  0.0f, 1.0f, 0.0f,
		30.0f,  -70.0f,  -50.0f, 1.0f,   0.0f, 0.9f, 0.0f,
		30.0f,  30.0f,  -50.0f, 1.0f,    0.0f, 0.6f, 0.0f,
		-70.0f,  30.0f, -50.0f, 1.0f,   0.0f, 0.2f, 0.0f,
		// varfurile (~rosii) din planul z=+50  
		// coordonate                   // culori			
		-70.0f,  -70.0f, 50.0f, 1.0f,  1.0f, 0.0f, 0.0f,
		30.0f,  -70.0f,  50.0f, 1.0f,   0.7f, 0.0f, 0.0f,
		30.0f,  30.0f,  50.0f, 1.0f,    0.5f, 0.0f, 0.0f,
		-70.0f,  30.0f, 50.0f, 1.0f,   0.1f, 0.0f, 0.0f,
	};
...
void RenderFunction(void)
{
	...
	projection = glm::ortho(-10, 10, -10, 10, 0, 10);
